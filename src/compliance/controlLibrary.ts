// JSON data for controls from https://github.com/kubescape/regolibrary/releases/download/v2/controls
...
export const controlLibrary: Control[] = [
  {
    ...
    rulesNames: ['anonymous-requests-to-kubelet-service-updated'],
    long_description:
      "By default, requests to the kubelet's HTTPS endpoint that are not rejected by other configured authentication methods are treated as anonymous requests, and given a username of system:anonymous and a group of system:unauthenticated.",
  ...
  },
  {
    ...
    attributes: {
      ...
      controlTypeTags: ['compliance', 'security-impact'],
    },
    description:
      'Attackers who obtain access to a pod can use its SA token to communicate with KubeAPI server. All pods with SA token mounted (if such token has a Role or a ClusterRole binding) are considerred potentially dangerous.',
    remediation:
    ...
    rulesNames: ['access-container-service-account-v1'],
    long_description:
  ...
  },
  {
    ...
    rulesNames: ['ingress-and-egress-blocked'],
    long_description:
  ...
  },
  {
    ...
    attributes: {
      controlTypeTags: ['compliance', 'devops'],
    ...
    rulesNames: ['resources-memory-limit-and-request'],
    controlID: 'C-0004',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126669/recommendations/1838680'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838624'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838664'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838648'],
    attributes: {},
    rulesNames: ['kubelet-protect-kernel-defaults'],
    baseScore: 2,
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838580'],
    rulesNames: ['ensure-that-the-admin.conf-file-permissions-are-set-to-600'],
    attributes: {},
    baseScore: 7,
    impact_statement: 'None.',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838626'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    attributes: {
      controlTypeTags: ['compliance', 'devops', 'security'],
      attackTracks: [
        {
    ...
    rulesNames: ['resources-cpu-limits'],
    controlID: 'C-0270',
    baseScore: 8.0,
    category: {
      name: 'Workload',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838615'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838673'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-etcd-cafile-argument-is-set-as-appropriate'],
    baseScore: 8,
  ...
  },
  {
    ...
    references: ['https://docs.aws.amazon.com/AmazonECR/latest/userguide/ECR_on_EKS.html'],
    attributes: {},
    rulesNames: ['ensure_nodeinstancerole_has_right_permissions_for_ecr'],
    baseScore: 6,
    impact_statement:
  ...
  },
  {
    ...
    rulesNames: ['rule-identify-old-k8s-registry'],
    long_description:
      'Kubernetes team has deprecated GCR (k8s.gcr.io) registry and recommends pulling Kubernetes components from the new registry (registry.k8s.io). This is mandatory from 1.27',
  ...
  },
  {
    ...
    description:
      'This control is intended to ensure that all the used container images are taken from the authorized repositories. It allows user to list all the approved repositories and will fail all the images taken from any repository outside of this list.',
    remediation: 'You should enable all trusted repositories in the parameters of this control.',
    rulesNames: ['container-image-repository', 'container-image-repository-v1'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126665/recommendations/1838631'],
    attributes: {},
    rulesNames: ['external-secret-storage'],
    baseScore: 5,
    category: {
      name: 'Control plane',
      id: 'Cat-1',
  ...
  },
  {
    ...
    description:
      'Mounting Container runtime socket (Unix socket) enables container to access Container runtime, retrieve sensitive information and execute commands, if Container runtime is available. This control identifies pods that attempt to mount Container runtime socket for accessing Container runtime.',
    remediation: 'Remove container runtime socket mount request or define an exception.',
    rulesNames: ['containers-mounting-docker-socket'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126659/recommendations/1838619'],
    rulesNames: [
  ...
  },
  {
    ...
    description:
      'If no network policy is defined, attackers who gain access to a container may use it to move laterally in the cluster. This control lists namespaces in which no network policy is defined.',
    remediation:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838649'],
    attributes: {},
    rulesNames: ['ensure-that-the-admission-control-plugin-AlwaysPullImages-is-set'],
    baseScore: 4,
    category: {
      name: 'Control plane',
      id: 'Cat-1',
  ...
  },
  {
    ...
    description:
      'Attackers may attempt to destroy data and resources in the cluster. This includes deleting deployments, configurations, storage, and compute resources. This control identifies all subjects that can delete resources.',
    remediation:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126659/recommendations/1838620'],
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126654/recommendations/1838578'],
    attributes: {},
    rulesNames: ['etcd-unique-ca'],
    baseScore: 8,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838661'],
    attributes: {},
    rulesNames: ['kubelet-rotate-kubelet-server-certificate'],
    baseScore: 6,
    impact_statement: 'None',
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['list-role-definitions-in-acr'],
    baseScore: 6,
    impact_statement:
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['Ensure-that-the-kubeconfig-file-permissions-are-set-to-644-or-more-restrictive'],
    baseScore: 6,
    impact_statement: 'None.',
  ...
  },
  {
    ...
    rulesNames: ['resources-memory-limits'],
    controlID: 'C-0271',
    baseScore: 8.0,
    category: {
      name: 'Workload',
  ...
  },
  {
    ...
    description:
      'When a cluster is deployed in the cloud, in some cases attackers can leverage their access to a container in the cluster to gain cloud credentials. This control determines if any workload contains a volume with potential access to cloud credential.',
    example:
    ...
    rulesNames: ['alert-mount-potential-credentials-paths'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838587'],
    rulesNames: ['ensure-that-the-scheduler.conf-file-ownership-is-set-to-root-root'],
    attributes: {},
    baseScore: 6,
    impact_statement: 'None',
  ...
  },
  {
    ...
    description:
      'All Kubernetes Secrets are stored primarily in etcd therefore it is important to encrypt it.',
    remediation:
      'Turn on the etcd encryption in your cluster, for more see the vendor documentation.',
    rulesNames: ['secret-etcd-encryption-cloud', 'etcd-encryption-native'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838642'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-authorization-mode-argument-includes-RBAC'],
    baseScore: 8,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838612'],
    attributes: {},
    rulesNames: [
      'pod-security-admission-restricted-applied-1',
      'pod-security-admission-restricted-applied-2',
  ...
  },
  {
    ...
    rulesNames: ['host-pid-ipc-privileges'],
    long_description:
      'Containers should be isolated from the host machine as much as possible. The hostPID and hostIPC fields in deployment yaml may allow cross-container influence and may expose the host itself to potentially malicious or destructive actions. This control identifies all pods using hostPID or hostIPC privileges.',
    controlID: 'C-0038',
    baseScore: 7.0,
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838586'],
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126654/recommendations/1838565'],
    attributes: {},
    rulesNames: ['etcd-client-auth-cert'],
    baseScore: 8,
    impact_statement:
  ...
  },
  {
    ...
    description:
      'Attackers with relevant permissions can run malicious commands in the context of legitimate containers in the cluster using \u201ckubectl exec\u201d command. This control determines which subjects have permissions to use this command.',
    remediation:
    ...
    rulesNames: ['exec-into-container-v1'],
    long_description:
  ...
  },
  {
    ...
    manual_test:
      'Run the below command (based on the file location on your system) on the each worker node. For example,\n\n \n```\nstat -c %a /var/lib/kubelet/config.yaml\n```Verify that the ownership is set to `root:root`.\n\n```',
    references: ['https://workbench.cisecurity.org/sections/1126659/recommendations/1838629'],
    rulesNames: ['ensure-that-the-kubelet-configuration-file-ownership-is-set-to-root-root'],
    attributes: {},
    baseScore: 7,
    impact_statement: 'None',
    default_value:
  ...
  },
  {
    ...
    rulesNames: ['anonymous-access-enabled'],
    baseScore: 7,
    category: {
      name: 'Control plane',
      subCategory: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838668'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-service-account-lookup-argument-is-set-to-true'],
    baseScore: 6,
    impact_statement: 'None',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838600'],
    attributes: {},
    rulesNames: ['pod-security-admission-applied-1', 'pod-security-admission-applied-2'],
    baseScore: 4,
    impact_statement:
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['psp-deny-hostnetwork'],
    baseScore: 5.0,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838655'],
    attributes: {},
    rulesNames: ['ensure-that-the-admission-control-plugin-NodeRestriction-is-set'],
    baseScore: 4,
    impact_statement: 'None',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838566'],
    rulesNames: [
      'ensure-that-the-controller-manager-pod-specification-file-ownership-is-set-to-root-root',
    ],
    attributes: {},
  ...
  },
  {
    ...
    description:
      'CVE-2022-0185 is a kernel vulnerability enabling privilege escalation and it can lead attackers to escape containers and take control over nodes. This control alerts on vulnerable kernel versions of Kubernetes nodes',
    remediation: 'Patch Linux kernel version to 5.16.2 or above',
    rulesNames: ['CVE-2022-0185'],
    long_description:
  ...
  },
  {
    ...
    attributes: {
      actionRequired: 'configuration',
      controlTypeTags: ['security', 'compliance', 'smartRemediation'],
      attackTracks: [
        {
          attackTrack: 'workload-external-track',
          categories: ['Privilege Escalation (Node)'],
        },
      ],
    },
    description:
      'Giving insecure or excessive capabilities to a container can increase the impact of the container compromise. This control identifies all the pods with dangerous capabilities (see documentation pages for details).',
    remediation: 'Remove all insecure capabilities which are not necessary for the container.',
    rulesNames: ['insecure-capabilities'],
    long_description:
  ...
  },
  {
    ...
    rulesNames: ['k8s-audit-logs-enabled-cloud', 'k8s-audit-logs-enabled-native'],
    long_description:
      'Audit logging is an important security feature in Kubernetes, it enables the operator to track requests to the cluster. It is important to use it so the operator has a record of events happened in Kubernetes',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126669/recommendations/1838678'],
    attributes: {},
    rulesNames: ['ensure-that-the-controller-manager-profiling-argument-is-set-to-false'],
    baseScore: 3,
  ...
  },
  {
    ...
    description:
      'If no network policy is defined, attackers who gain access to a single container may use it to probe the network. This control lists all namespaces in which no network policies are defined.',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838643'],
    attributes: {},
    rulesNames: ['enforce-kubelet-client-tls-authentication-updated'],
    baseScore: 6,
    impact_statement: 'You require TLS to be configured on apiserver as well as kubelets.',
  ...
  },
  {
    ...
    rulesNames: ['rbac-enabled-cloud', 'rbac-enabled-native'],
    long_description:
      'RBAC is the most advanced and well accepted mode of authorizing users of the Kubernetes API',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126667/recommendations/1838633'],
    attributes: {},
    rulesNames: ['list-all-namespaces'],
    baseScore: 5,
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838576'],
    attributes: {},
    rulesNames: ['ensure-that-the-Container-Network-Interface-file-ownership-is-set-to-root-root'],
    baseScore: 6,
    impact_statement: 'None',
    default_value: 'NA',
    category: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838654'],
    attributes: {},
    rulesNames: ['kubelet-hostname-override'],
    baseScore: 3,
    impact_statement:
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['rule-hostile-multitenant-workloads'],
    baseScore: 5,
    impact_statement: '',
    default_value: '',
    scanningScope: {
  ...
  },
  {
    ...
    description:
      'Attackers may delete Kubernetes events to avoid detection of their activity in the cluster. This control identifies all the subjects that can delete Kubernetes events.',
    remediation:
  ...
  },
  {
    ...
    rulesNames: ['image-pull-policy-is-not-set-to-always'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126661/recommendations/1838588'],
    attributes: {},
    rulesNames: ['cluster-admin-role'],
    baseScore: 8,
    impact_statement:
  ...
  },
  {
    ...
    attributes: {
      controlTypeTags: ['security', 'compliance', 'devops'],
    },
    description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126654/recommendations/1838575'],
    attributes: {},
    rulesNames: ['etcd-peer-auto-tls-disabled'],
    baseScore: 6,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838625'],
    attributes: {},
    rulesNames: [
      'pod-security-admission-baseline-applied-1',
      'pod-security-admission-baseline-applied-2',
  ...
  },
  {
    ...
    manual_test:
      'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-controller-manager\n\n```\n Verify that `RotateKubeletServerCertificate` argument exists and is set to `true`.',
    references: ['https://workbench.cisecurity.org/sections/1126669/recommendations/1838682'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838644'],
    attributes: {},
    rulesNames: ['ensure-that-the-admission-control-plugin-EventRateLimit-is-set'],
    baseScore: 4,
  ...
  },
  {
    ...
    rulesNames: ['sudo-in-container-entrypoint'],
    long_description:
      'Adding sudo to a container entry point command may escalate process privileges and allow access to forbidden resources. This control checks all the entry point commands in all containers in the pod to find those that have sudo command.',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838579'],
    attributes: {},
    rulesNames: ['ensure-that-the-etcd-data-directory-ownership-is-set-to-etcd-etcd'],
    baseScore: 7,
    impact_statement: 'None',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126661/recommendations/1838590'],
    attributes: {},
    rulesNames: ['rule-can-list-get-secrets-v1'],
    baseScore: 6,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838561'],
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126669/recommendations/1838677'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126670/recommendations/1838685'],
    attributes: {},
    rulesNames: ['ensure-that-the-scheduler-bind-address-argument-is-set-to-127.0.0.1'],
    baseScore: 5,
    impact_statement: 'None',
  ...
  },
  {
    ...
    rulesNames: ['pv-without-encryption'],
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838639'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    rulesNames: ['resources-cpu-requests'],
    controlID: 'C-0268',
    baseScore: 3.0,
    category: {
      name: 'Workload',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126659/recommendations/1838607'],
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838667'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-request-timeout-argument-is-set-as-appropriate'],
    baseScore: 4,
    impact_statement: 'None',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126654/recommendations/1838562'],
    attributes: {},
    rulesNames: ['etcd-tls-enabled'],
    baseScore: 8,
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838672'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-client-ca-file-argument-is-set-as-appropriate'],
    baseScore: 8,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838601'],
    attributes: {},
    rulesNames: [
      'pod-security-admission-baseline-applied-1',
      'pod-security-admission-baseline-applied-2',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838584'],
    rulesNames: ['ensure-that-the-admin.conf-file-ownership-is-set-to-root-root'],
    attributes: {},
    baseScore: 7,
    impact_statement: 'None.',
  ...
  },
  {
    ...
    rulesNames: ['workload-with-administrative-roles'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838656'],
    attributes: {},
    rulesNames: ['kubelet-event-qps'],
    baseScore: 2,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126661/recommendations/1838597'],
    attributes: {},
    rulesNames: ['rule-can-bind-escalate', 'rule-can-impersonate-users-groups-v1'],
    baseScore: 6,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126669/recommendations/1838679'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126659/recommendations/1838598'],
    rulesNames: [
  ...
  },
  {
    ...
    rulesNames: ['list-all-mutating-webhooks'],
    controlID: 'C-0039',
    baseScore: 4.0,
    category: {
      name: 'Access control',
  ...
  },
  {
    ...
    test: 'Check for each namespace if there is a network policy defined.',
    references: ['https://workbench.cisecurity.org/sections/1126664/recommendations/1838628'],
    attributes: {},
    rulesNames: ['internal-networking'],
    baseScore: 4,
    impact_statement:
  ...
  },
  {
    ...
    attributes: {
      ...
      controlTypeTags: ['security-impact', 'compliance'],
    },
    description:
      'Attackers who have permissions to access secrets can access sensitive information that might include credentials to various services. This control determines which user, group or service account can list/get secrets.',
    remediation:
  ...
  },
  {
    ...
    manual_test: '',
    references: ['<https://learn.microsoft.com/en-us/azure/aks/private-clusters>'],
    attributes: {},
    rulesNames: ['ensure-clusters-are-created-with-private-nodes'],
    baseScore: 8,
    impact_statement:
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['restrict-access-to-the-control-plane-endpoint'],
    baseScore: 8,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838659'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-secure-port-argument-is-not-set-to-0'],
    baseScore: 8,
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['psp-deny-root-container'],
    baseScore: 6.0,
    impact_statement: 'Pods with containers which run as the root user will not be permitted.',
    default_value: 'By default, PodSecurityPolicies are not defined.',
    scanningScope: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838658'],
    attributes: {},
    rulesNames: ['kubelet-rotate-certificates'],
    baseScore: 6,
    impact_statement: 'None',
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['ensure-service-principle-has-read-only-permissions'],
    baseScore: 6,
    impact_statement:
      'A separate dedicated service account may be required for use by build servers and other robot users pushing or managing container images.',
    default_value: '',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838675'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-encryption-providers-are-appropriately-configured'],
    baseScore: 7,
    impact_statement: 'None',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838638'],
    attributes: {},
    rulesNames: ['anonymous-requests-to-kubelet-service-updated'],
    baseScore: 7,
  ...
  },
  {
    ...
    rulesNames: ['non-root-containers'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838650'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838577'],
    rulesNames: [
  ...
  },
  {
    ...
    manual_test: '',
    references: ['<https://docs.microsoft.com/en-us/azure/aks/manage-azure-rbac>'],
    attributes: {},
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126669/recommendations/1838681'],
    attributes: {},
    rulesNames: ['ensure-that-the-controller-manager-root-ca-file-argument-is-set-as-appropriate'],
    baseScore: 7,
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126659/recommendations/1838618'],
    rulesNames: [
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['encrypt-traffic-to-https-load-balancers-with-tls-certificates'],
    baseScore: 8,
    impact_statement: '',
    default_value: '',
    scanningScope: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126667/recommendations/1838635'],
    attributes: {},
    rulesNames: ['set-seccomp-profile-RuntimeDefault'],
    baseScore: 4,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838652'],
    attributes: {},
    rulesNames: ['ensure-that-the-admission-control-plugin-ServiceAccount-is-set'],
    baseScore: 3,
    impact_statement: 'None.',
  ...
  },
  {
    ...
    manual_test: '',
    references: ['https://docs.aws.amazon.com/eks/latest/userguide/fargate.html'],
    attributes: {},
    rulesNames: ['alert-fargate-not-in-use'],
    baseScore: 3,
    impact_statement: '',
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['ensure-aws-policies-are-present'],
    baseScore: 6,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838645'],
    attributes: {},
    rulesNames: ['read-only-port-enabled-updated'],
    baseScore: 4,
    impact_statement:
  ...
  },
  {
    ...
    description:
      'An SSH server that is running inside a container may be used by attackers to get remote access to the container. This control checks if pods have an open SSH port (22/2222).',
    remediation:
      'Remove SSH from the container image or limit the access to the SSH server using network policies.',
    rulesNames: ['rule-can-ssh-to-pod-v1'],
    long_description:
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['psp-deny-allowed-capabilities'],
    baseScore: 5.0,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838614'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-DenyServiceExternalIPs-is-not-set'],
    baseScore: 4,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838571'],
    rulesNames: [
  ...
  },
  {
    ...
    description:
      'Attackers who have cluster admin permissions (can perform any action on any resource), can take advantage of their privileges for malicious activities. This control determines which subjects have cluster admin permissions.',
    remediation:
    ...
    rulesNames: ['rule-list-all-cluster-admins-v1'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838605'],
    attributes: {},
    rulesNames: [
      'pod-security-admission-baseline-applied-1',
      'pod-security-admission-baseline-applied-2',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838617'],
    attributes: {},
    rulesNames: [
      'pod-security-admission-baseline-applied-1',
      'pod-security-admission-baseline-applied-2',
  ...
  },
  {
    ...
    description:
      'CVE-2022-39328 is a critical vulnerability in Grafana, it might enable attacker to access unauthorized endpoints under heavy load.',
    remediation: 'Update your Grafana to 9.2.4 or above',
    rulesNames: ['CVE-2022-39328'],
    long_description:
  ...
  },
  {
    ...
    description:
      'Cluster takeover roles include workload creation or update and secret access. They can easily lead to super privileges in the cluster. If an attacker can exploit this workload then the attacker can take over the cluster using the RBAC privileges this workload is assigned to.',
    remediation:
    ...
    rulesNames: ['workload-with-cluster-takeover-roles'],
    long_description:
  ...
  },
  {
    ...
    rulesNames: ['label-usage-for-resources'],
    long_description:
      'It is recommended to set labels that identify semantic attributes of your application or deployment. For example, { app: myapp, tier: frontend, phase: test, deployment: v3 }. These labels can used to assign policies to logical groups of the deployments as well as for presentation and tracking purposes. This control helps you find deployments without any of the expected labels.',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838669'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    description:
      'CVE-2022-24348 is a major software supply chain 0-day vulnerability in the popular open source CD platform Argo CD which can lead to privilege escalation and information disclosure.',
    remediation: 'Update your ArgoCD deployment to fixed versions (v2.1.9,v2.2.4 or v2.3.0)',
    rulesNames: ['CVE-2022-24348'],
    long_description:
  ...
  },
  {
    ...
    description:
      'Attackers who gain access to a container, may query the metadata API service for getting information about the underlying node. This control checks if there is access from the nodes to cloud providers instance metadata services.',
    remediation: 'Disable metadata services for pods in cloud provider settings.',
    rulesNames: ['instance-metadata-api-access'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126659/recommendations/1838603'],
    rulesNames: ['if-proxy-kubeconfig-file-exists-ensure-ownership-is-set-to-root-root'],
    attributes: {},
    baseScore: 6,
    impact_statement: 'None',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126654/recommendations/1838569'],
    attributes: {},
    rulesNames: ['etcd-peer-tls-enabled'],
    baseScore: 7,
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838662'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-audit-log-path-argument-is-set'],
    baseScore: 7,
    impact_statement: 'None',
    default_value: 'By default, auditing is not enabled.',
    category: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838610'],
    attributes: {},
    rulesNames: [
      'pod-security-admission-baseline-applied-1',
      'pod-security-admission-baseline-applied-2',
  ...
  },
  {
    ...
    attributes: {
      ...
      attackTracks: [
        {
          attackTrack: 'workload-external-track',
          categories: ['Lateral Movement (Network)'],
        },
      ],
    },
    description:
      'Potential attackers may gain access to a pod and inherit access to the entire host network. For example, in AWS case, they will have access to the entire VPC. This control identifies all the pods with host network access enabled.',
    remediation:
    ...
    rulesNames: ['host-network-access'],
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126661/recommendations/1838592'],
    attributes: {},
    rulesNames: ['rule-can-create-pod'],
    baseScore: 5,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838621'],
    attributes: {},
    rulesNames: [
      'pod-security-admission-restricted-applied-1',
      'pod-security-admission-restricted-applied-2',
  ...
  },
  {
    ...
    manual_test:
      'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--profiling` argument is set to `false`.',
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838660'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-profiling-argument-is-set-to-false'],
    baseScore: 3,
    impact_statement: 'Profiling information would not be available.',
    default_value: 'By default, profiling is enabled.',
    category: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838622'],
    attributes: {},
    rulesNames: [
      'pod-security-admission-restricted-applied-1',
      'pod-security-admission-restricted-applied-2',
  ...
  },
  {
    ...
    rulesNames: ['rule-can-portforward-v1'],
    long_description:
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['system-authenticated-allowed-to-take-over-cluster'],
    baseScore: 7,
    category: {
      name: 'Control plane',
      subCategory: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838671'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126665/recommendations/1838630'],
    attributes: {},
    rulesNames: ['rule-secrets-in-env-var'],
    baseScore: 4,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838564'],
    rulesNames: [
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['alert-container-optimized-os-not-in-use'],
    baseScore: 3,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838663'],
    attributes: {},
    rulesNames: ['kubelet-strong-cryptographics-ciphers'],
    baseScore: 5,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126659/recommendations/1838585'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: [],
    attributes: {},
    rulesNames: ['ensure-external-secrets-storage-is-in-use'],
    baseScore: 6.0,
    impact_statement: 'None',
    default_value: 'By default, no external secret management is configured.',
    scanningScope: {
  ...
  },
  {
    ...
    description:
      'PSP enable fine-grained authorization of pod creation and it is important to enable it',
    remediation:
    ...
    rulesNames: ['psp-enabled-cloud', 'psp-enabled-native'],
    long_description:
  ...
  },
  {
    ...
    references: [],
    attributes: {},
    rulesNames: ['has-image-signature'],
    baseScore: 7,
    impact_statement: '',
    default_value: '',
    category: {
  ...
  },
  {
    ...
    rulesNames: ['excessive_amount_of_vulnerabilities_pods'],
    long_description:
      'Container images with multiple Critical and High sevirity vulnerabilities increase the risk of potential exploit. This control lists all such images according to the threashold provided by the customer.',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838651'],
    attributes: {},
    rulesNames: ['kubelet-ip-tables'],
    baseScore: 3,
    impact_statement:
  ...
  },
  {
    ...
    rulesNames: ['resources-cpu-limit-and-request'],
    controlID: 'C-0050',
    baseScore: 8.0,
    category: {
      name: 'Workload',
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['ensure-image-scanning-enabled-cloud'],
    baseScore: 5,
    impact_statement:
  ...
  },
  {
    ...
    manual_test:
      'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--anonymous-auth` argument is set to `false`.',
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838609'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-anonymous-auth-argument-is-set-to-false'],
    baseScore: 8,
    impact_statement: 'Anonymous requests will be rejected.',
    default_value: 'By default, anonymous access is enabled.',
    category: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838623'],
    attributes: {},
    rulesNames: [
      'pod-security-admission-baseline-applied-1',
      'pod-security-admission-baseline-applied-2',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838606'],
    rulesNames: [
  ...
  },
  {
    ...
    attributes: {
      ...
      controlTypeTags: ['security', 'compliance', 'security-impact'],
    },
    description:
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['secret-etcd-encryption-cloud'],
    baseScore: 6,
    impact_statement: '',
    default_value: '',
    scanningScope: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838670'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126654/recommendations/1838567'],
    attributes: {},
    rulesNames: ['etcd-auto-tls-disabled'],
    baseScore: 6,
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838647'],
    attributes: {},
    rulesNames: ['ensure-that-the-admission-control-plugin-AlwaysAdmit-is-not-set'],
    baseScore: 8,
    impact_statement:
  ...
  },
  {
    ...
    rulesNames: ['Symlink-Exchange-Can-Allow-Host-Filesystem-Access'],
    controlID: 'C-0058',
    baseScore: 6.0,
    category: {
      name: 'Workload',
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['psp-deny-privileged-container'],
    baseScore: 8.0,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838604'],
    rulesNames: ['ensure-that-the-Kubernetes-PKI-directory-and-file-ownership-is-set-to-root-root'],
    attributes: {},
    baseScore: 8,
    impact_statement: 'None',
    default_value:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126657/recommendations/1838583'],
    attributes: {},
    rulesNames: ['audit-policy-content'],
    baseScore: 5,
    impact_statement:
  ...
  },
  {
    ...
    rulesNames: ['resources-memory-requests'],
    controlID: 'C-0269',
    baseScore: 3.0,
    category: {
      name: 'Workload',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838563'],
    rulesNames: ['ensure-that-the-API-server-pod-specification-file-ownership-is-set-to-root-root'],
    attributes: {},
    baseScore: 6,
    impact_statement: 'None',
  ...
  },
  {
    ...
    rulesNames: ['rule-access-dashboard-subject-v1', 'rule-access-dashboard-wl-v1'],
    long_description:
  ...
  },
  {
    ...
    rulesNames: ['immutable-container-filesystem'],
    long_description:
  ...
  },
  {
    ...
    remediation:
      'Ensure all the webhooks are necessary. Use exception mechanism to prevent repititive notifications.',
    rulesNames: ['list-all-validating-webhooks'],
    controlID: 'C-0036',
    baseScore: 3.0,
    category: {
      name: 'Access control',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838573'],
    rulesNames: ['ensure-that-the-etcd-pod-specification-file-ownership-is-set-to-root-root'],
    attributes: {},
    baseScore: 6,
    impact_statement: 'None',
    default_value:
  ...
  },
  {
    ...
    description:
      'Container images with known critical vulnerabilities pose elevated risk if they are exposed to the external traffic. This control lists all images with such vulnerabilities if either LoadBalancer or NodePort service is assigned to them.',
    remediation:
      "Either update the container image to fix the vulnerabilities (if such fix is available) or reassess if this workload must be exposed to the outseide traffic. If no fix is available, consider periodic restart of the pod to minimize the risk of persistant intrusion. Use exception mechanism if you don't want to see this report again.",
    rulesNames: ['exposed-critical-pods'],
    long_description:
  ...
  },
  {
    ...
    manual_test:
      'Run the below command (based on the file location on your system) on the each worker node. For example,\n\n \n```\nstat -c %a /etc/systemd/system/kubelet.service.d/10-kubeadm.conf\n\n```\n Verify that the ownership is set to `root:root`.',
    references: ['https://workbench.cisecurity.org/sections/1126659/recommendations/1838589'],
    attributes: {},
    rulesNames: ['ensure-that-the-kubelet-service-file-ownership-is-set-to-root-root'],
    baseScore: 6,
    impact_statement: 'None',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838593'],
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838634'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    manual_test:
      'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-scheduler\n\n```\n Verify that the `--profiling` argument is set to `false`.',
    references: ['https://workbench.cisecurity.org/sections/1126670/recommendations/1838684'],
    attributes: {},
    rulesNames: ['ensure-that-the-scheduler-profiling-argument-is-set-to-false'],
    baseScore: 3,
    impact_statement: 'Profiling information would not be available.',
    default_value: 'By default, profiling is enabled.',
    category: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838608'],
    rulesNames: ['ensure-that-the-Kubernetes-PKI-key-file-permissions-are-set-to-600'],
    attributes: {},
    baseScore: 8,
    impact_statement: 'None',
  ...
  },
  {
    ...
    attributes: {
      microsoftMitreColumns: ['Persistence', 'Lateral Movement'],
      controlTypeTags: ['security', 'compliance', 'devops', 'security-impact', 'smartRemediation'],
      attackTracks: [
        {
          attackTrack: 'workload-external-track',
          categories: ['Privilege Escalation (Node)'],
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['rule-cni-enabled-aks'],
    baseScore: 6,
    impact_statement:
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['ensure-https-loadbalancers-encrypted-with-tls-aws'],
    baseScore: 5.0,
    impact_statement: '',
    default_value: '',
    scanningScope: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126657/recommendations/1838582'],
    attributes: {},
    rulesNames: ['k8s-audit-logs-enabled-native-cis'],
    baseScore: 5,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838570'],
    rulesNames: ['ensure-that-the-scheduler-pod-specification-file-ownership-is-set-to-root-root'],
    attributes: {},
    baseScore: 6,
    impact_statement: 'None',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126659/recommendations/1838613'],
    rulesNames: ['ensure-that-the-kubeconfig-kubelet.conf-file-ownership-is-set-to-root-root'],
    attributes: {},
    baseScore: 6,
    impact_statement: 'None',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126654/recommendations/1838572'],
    attributes: {},
    rulesNames: ['etcd-peer-client-auth-cert'],
    baseScore: 7,
    impact_statement:
      'All peers attempting to communicate with the etcd server will require a valid client certificate for authentication.',
    category: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838574'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    attributes: {},
    description:
      'Identifies Kubernetes clusters running on outdated versions. Using old versions can expose clusters to known vulnerabilities, compatibility issues, and miss out on improved features and security patches. Keeping Kubernetes up-to-date is crucial for maintaining security and operational efficiency.',
    remediation:
    ...
    rulesNames: ['outdated-k8s-version'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838657'],
    attributes: {},
    rulesNames: ['validate-kubelet-tls-configuration-updated'],
    baseScore: 7,
    impact_statement: '',
    default_value: '',
    category: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126662/recommendations/1838602'],
    attributes: {},
    rulesNames: [
      'pod-security-admission-baseline-applied-1',
      'pod-security-admission-baseline-applied-2',
  ...
  },
  {
    ...
    description:
      'In cases where the Kubernetes cluster is provided by a CSP (e.g., AKS in Azure, GKE in GCP, or EKS in AWS), compromised cloud credential can lead to the cluster takeover. Attackers may abuse cloud account credentials or IAM mechanism to the cluster\u2019s management layer.',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838665'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    description:
      'This control detect workloads that are exposed on Internet through a Gateway API (HTTPRoute,TCPRoute, UDPRoute). It fails in case it find workloads connected with these resources.',
    remediation:
      'The user can evaluate its exposed resources and apply relevant changes wherever needed.',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126667/recommendations/1838636'],
    attributes: {
      controlTypeTags: ['security', 'compliance'],
      attackTracks: [
        {
  ...
  },
  {
    ...
    description:
      'CVE-2022-47633 is a high severity vulnerability in Kyverno, it enables attackers to bypass the image signature validation of policies using a malicious image repository or MITM proxy',
    remediation: 'Update your Grafana to 9.2.4 or above',
    rulesNames: ['CVE-2022-47633'],
    long_description:
  ...
  },
  {
    ...
    rulesNames: ['verify-image-signature'],
    baseScore: 7,
    impact_statement: '',
    default_value: '',
    category: {
  ...
  },
  {
    ...
    description:
      "If attackers have permissions to modify the coredns ConfigMap they can change the behavior of the cluster\u2019s DNS, poison it, and override the network identity of other services. This control identifies all subjects allowed to update the 'coredns' configmap.",
    remediation:
    ...
    rulesNames: ['rule-can-update-configmap-v1'],
    long_description:
  ...
  },
  {
    ...
    rulesNames: ['pods-in-default-namespace'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838568'],
    rulesNames: [
  ...
  },
  {
    ...
    manual_test:
      'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-controller-manager\n\n```\n Verify that the `--bind-address` argument is set to 127.0.0.1',
    references: ['https://workbench.cisecurity.org/sections/1126669/recommendations/1838683'],
    attributes: {},
    rulesNames: ['ensure-that-the-controller-manager-bind-address-argument-is-set-to-127.0.0.1'],
    baseScore: 5,
    impact_statement: 'None',
    default_value: 'By default, the `--bind-address` parameter is set to 0.0.0.0',
    category: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126661/recommendations/1838595'],
    attributes: {},
    rulesNames: ['automount-service-account'],
    baseScore: 5,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838676'],
    attributes: {},
    rulesNames: ['ensure-that-the-API-Server-only-makes-use-of-Strong-Cryptographic-Ciphers'],
    baseScore: 5,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838641'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-authorization-mode-argument-includes-Node'],
    baseScore: 5,
    impact_statement: 'None',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838640'],
    attributes: {},
    rulesNames: ['kubelet-authorization-mode-alwaysAllow'],
    baseScore: 6,
  ...
  },
  {
    ...
    description:
      'CVE-2022-23648 is a vulnerability of containerd enabling attacker to gain access to read-only copies of arbitrary files from the host using specially-crafted manifests',
    remediation: 'Patch containerd to 1.6.1, 1.5.10, 1.4.12  or above',
    rulesNames: ['CVE-2022-23648'],
    long_description:
  ...
  },
  {
    ...
    rulesNames: ['nginx-ingress-snippet-annotation-vulnerability'],
    controlID: 'C-0059',
    baseScore: 8.0,
    category: {
      name: 'Workload',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126668/recommendations/1838646'],
    attributes: {},
    rulesNames: ['kubelet-streaming-connection-idle-timeout'],
    baseScore: 3,
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838674'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126661/recommendations/1838594'],
    attributes: {},
    rulesNames: ['automount-default-service-account', 'namespace-without-service-account'],
    baseScore: 5,
    impact_statement:
  ...
  },
  {
    ...
    attributes: {
      microsoftMitreColumns: ['Privilege escalation'],
      controlTypeTags: ['security', 'smartRemediation'],
    },
    description:
    ...
    rulesNames: ['rule-privilege-escalation'],
    long_description:
  ...
  },
  {
    ...
    description:
      'Exposing a sensitive interface to the internet poses a security risk. It might enable attackers to run malicious code or deploy containers in the cluster. This control checks if known components (e.g. Kubeflow, Argo Workflows, etc.) are deployed and exposed services externally.',
    remediation:
      'Consider blocking external interfaces or protect them with appropriate security tools.',
    rulesNames: ['exposed-sensitive-interfaces-v1'],
    long_description:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126664/recommendations/1838627'],
    attributes: {},
    rulesNames: ['ensure-that-the-cni-in-use-supports-network-policies'],
    baseScore: 4,
    impact_statement: 'None',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838666'],
    attributes: {},
    rulesNames: [
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838611'],
    attributes: {},
    rulesNames: ['ensure-that-the-api-server-token-auth-file-parameter-is-not-set'],
    baseScore: 8,
    impact_statement:
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126653/recommendations/1838599'],
    rulesNames: ['ensure-that-the-controller-manager.conf-file-ownership-is-set-to-root-root'],
    attributes: {},
    baseScore: 6,
    impact_statement: 'None',
  ...
  },
  {
    ...
    attributes: {},
    rulesNames: ['ensure-default-service-accounts-has-only-default-roles'],
    baseScore: 7,
    impact_statement: '',
    default_value: '',
    scanningScope: {
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126661/recommendations/1838591'],
    attributes: {},
    rulesNames: ['rule-list-all-cluster-admins-v1'],
    baseScore: 7,
    impact_statement: '',
  ...
  },
  {
    ...
    references: ['https://workbench.cisecurity.org/sections/1126663/recommendations/1838653'],
    attributes: {},
    rulesNames: ['ensure-that-the-admission-control-plugin-NamespaceLifecycle-is-set'],
    baseScore: 3,
    impact_statement: 'None',
  ...
  },
  {
    ...
    rulesNames: ['unauthenticated-service'],
    baseScore: 7,
    impact_statement: '',
    default_value: '',
    category: {
  ...
  },
  {
    ...
    rulesNames: ['rule-can-impersonate-users-groups-v1'],
    controlID: 'C-0065',
    baseScore: 6.0,
  ...
  },
  {
    ...
    rulesNames: ['k8s-common-labels-usage'],
    long_description:
      "Kubernetes common labels help manage and monitor Kubernetes cluster using different tools such as kubectl, dashboard and others in an interoperable way. Refer to https://kubernetes.io/docs/concepts/overview/working-with-objects/common-labels/ for more information. This control helps you find objects that don't have any of these labels defined.",
